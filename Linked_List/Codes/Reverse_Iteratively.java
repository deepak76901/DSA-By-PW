class Reverse_Iteratively {
    ...
    public void insertAtEnd(int newData){
        ...
        // Reverse_Iteratively is empty
        if(head == null){
            head = new Node(newData);
            return;
        }

        // Reverse_Iteratively is not empty
        newNode.next = null;
        Node temp = head;
    ...
    // implementation of deletion of a node in a Reverse_Iteratively
    ...
    // implementation of reversal of a Reverse_Iteratively using an iterative approach
    ...
    // implementation of displaying the Reverse_Iteratively
    ...
    public static void main(String[] args) {
        Reverse_Iteratively llist = new Reverse_Iteratively();
        llist.insertAtEnd(2);
        llist.insertAtEnd(4);
        llist.insertAtEnd(8);
       ...
       llist.displayLL();
        ...
        /* 
        llist.deleteNode(0);
        System.out.println("Deletion of a node from a Reverse_Iteratively");
        llist.displayLL();
        System.out.println();
        */
