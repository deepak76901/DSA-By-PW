class Insertion_After_node {
    ...
    public void insertAtEnd(int newData){
        ...
        // Insertion_After_node is empty
        if(head == null){
            head = new Node(newData);
            return;
        }

        // Insertion_After_node is not empty
        newNode.next = null;
        Node temp = head;
    ...
    // implementation of displaying the Insertion_After_node
    ...
    public static void main(String[] args) {
        Insertion_After_node llist = new Insertion_After_node();
        llist.insertAtEnd(2);
        llist.insertAtEnd(4);
        llist.insertAtEnd(8);
