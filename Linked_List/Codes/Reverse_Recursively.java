class Reverse_Recursively {
    ...
    public void insertAtEnd(int newData){
        ...
        // Reverse_Recursively is empty
        if(head == null){
            head = new Node(newData);
            return;
        }

        // Reverse_Recursively is not empty
        newNode.next = null;
        Node temp = head;
    ...
    // implementation of deletion of a node in a Reverse_Recursively
    ...
    // implementation of reversal of a Reverse_Recursively using an iterative approach
    ...
    // implementation of displaying the Reverse_Recursively
    ...
    public static void main(String[] args) {
        Reverse_Recursively llist = new Reverse_Recursively();
        llist.insertAtEnd(2);
        llist.insertAtEnd(4);
        llist.insertAtEnd(8);
       ...
       llist.displayLL();
        ...
        /* 
        llist.deleteNode(0);
        System.out.println("Deletion of a node from a Reverse_Recursively");
        llist.displayLL();
        System.out.println();
        */
