class Cycle_Detection {
    ...
    public void insertAtEnd(int newData){
        ...
        // Cycle_Detection is empty
        if(head == null){
            head = new Node(newData);
            return;
        }

        // Cycle_Detection is not empty
        newNode.next = null;
        Node temp = head;
    ...
    // implementation of deletion of a node in a Cycle_Detection
    ...
    // implementation of reversal of a Cycle_Detection using an iterative approach
    ...
    // implementation of displaying the Cycle_Detection
    ...
    public static void main(String[] args) {
        Cycle_Detection llist = new Cycle_Detection();
        llist.insertAtEnd(2);
        llist.insertAtEnd(4);
        llist.insertAtEnd(8);
       ...
       llist.displayLL();
        ...
        /* 
        llist.deleteNode(0);
        System.out.println("Deletion of a node from a Cycle_Detection");
        llist.displayLL();
        System.out.println();
        */
